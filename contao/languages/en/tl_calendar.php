 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_calendar']['enableInstructorReminderNotification'] = ['Enable reminder tool', 'If the remider tool is activated, event managers will be informed at regular intervals by email that they still have unprocessed participant requests in the event tool.'];
